...
# This will navigate to the home page of the application, in this case it will be base_generic.html
def home(request):
...
# Displays a list of service requests submitted by the logged-in user.
@login_required
